<template>
	...
	<el-breadcrumb separator="/">
		  	...
		  	<el-breadcrumb-item :to="{ name: 'personal' }">个人中心</el-breadcrumb-item>
...
<script>
	import {itemDetail, getUser, getNoteList ,getNoteListByProject} from '../../ajax/get.js'
