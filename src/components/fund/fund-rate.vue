<template>
	<div>
		<div class="fund-summary" v-show="personal==false" style="width:100%">
			<div class="edit" @click="dialogFormVisible = true" v-if="user.role.authority.project_grade==1" >
				<i class="el-icon-edit"></i>
				评分
			</div>
			<div  class="ratechart" id='ratechart'></div>
			<div class="sum-item">
